...
INSERT INTO `Paragraph` VALUES (1,'химическое сырье','./0a69d353134277510db94cd4665f8c0a_1.jpg',1,1,1),(2,'бочки, кубовые ёмкости','./DSC_0014.JPG',1,4,0),(3,'продукция для разметки дорог','./autodor_emal_d3H8t2a.jpg',0,3,1),(4,'автошампунь (пена)','./autoshampoo_a04O8mp.jpg',0,2,0),(5,'теплоноситель, антифриз, тосол','./antifreeze_8bDaKrm.jpg',0,6,0),(6,'автогрузоперевозки','./gruzo.jpg',1,5,1),(7,'собственная спецтехника','./sd300_200_ru_0323_detail.jpg',1,7,1);
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$24000$Kaky1HQagglt$1VEuegLXfAtC6kMIkpvuQxpwutdgIw1NRED9qlNbY/I=','2016-08-09 12:32:20',1,'ancel','','','anceladamusic@gmail.com',1,1,'2016-07-30 15:15:25');
...
-- Dump completed on 2016-08-09 16:46:01
