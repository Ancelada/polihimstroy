...
INSERT INTO `Paragraph` VALUES (1,'химическое сырье','./him_siryo_57tkMMo.jpg'),(2,'бочки, кубовые ёмкости','./cubes_SiIeIWI.jpg'),(3,'продукция для разметки дорог','./autodor_emal_d3H8t2a.jpg'),(4,'автошампунь (пена)','./autoshampoo_a04O8mp.jpg'),(5,'теплоноситель, антифриз, тосол','./antifreeze_8bDaKrm.jpg');
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$24000$Kaky1HQagglt$1VEuegLXfAtC6kMIkpvuQxpwutdgIw1NRED9qlNbY/I=','2016-08-06 12:12:24',1,'ancel','','','anceladamusic@gmail.com',1,1,'2016-07-30 15:15:25');
...
INSERT INTO `django_admin_log` VALUES (1,'2016-07-31 12:32:19','1','химическое сырье',1,'Добавлено.',7,1),(2,'2016-07-31 12:32:58','2','бочки, кубовые ёмкости',1,'Добавлено.',7,1),(3,'2016-07-31 12:33:29','3','лакокрасочная продукция',1,'Добавлено.',7,1),(4,'2016-07-31 12:34:23','3','продукция для разметки дорожного покрытия',2,'Изменен Name.',7,1),(5,'2016-07-31 12:34:57','4','автошампунь (пена)',1,'Добавлено.',7,1),(6,'2016-07-31 12:35:26','5','теплоноситель, антифриз, тосол',1,'Добавлено.',7,1),(7,'2016-08-06 12:12:39','3','продукция для разметки дорог',2,'Изменен Name.',7,1);
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(7,'mainapp','paragraph'),(8,'mainapp','unit'),(6,'sessions','session');
...
INSERT INTO `django_session` VALUES ('8pv1y1x0i7yn4p9cl6y3b2ewhywdxo6u','NTNiMGZmYmFlYjBhZTQzOTc0ZDRiNDY4NmFjZWEzYWE2OTdkYjNlMjp7Il9hdXRoX3VzZXJfaGFzaCI6IjRiN2M0OWNlYmY3MTFkYTJkOWZlZTMxZGQzMWNiZjBjNWZkYTU0MTciLCJfYXV0aF91c2VyX2JhY2tlbmQiOiJkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZCIsIl9hdXRoX3VzZXJfaWQiOiIxIn0=','2016-08-20 12:12:24'),('eqeve937i7b3hwj8peusbdgdaj2seyvp','NTNiMGZmYmFlYjBhZTQzOTc0ZDRiNDY4NmFjZWEzYWE2OTdkYjNlMjp7Il9hdXRoX3VzZXJfaGFzaCI6IjRiN2M0OWNlYmY3MTFkYTJkOWZlZTMxZGQzMWNiZjBjNWZkYTU0MTciLCJfYXV0aF91c2VyX2JhY2tlbmQiOiJkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZCIsIl9hdXRoX3VzZXJfaWQiOiIxIn0=','2016-08-13 15:15:38');
...
-- Dump completed on 2016-08-07 11:05:27
