...
INSERT INTO `Paragraph` VALUES (1,'химическое сырье','./him_veshestva-1024x681.jpg',1,1,1,1),(2,'бочки, кубовые ёмкости','./tr-3wFMXe7w.jpg',1,4,0,NULL),(3,'продукция для разметки дорог','./autodor_emal_d3H8t2a.jpg',0,3,1,NULL),(4,'автошампунь (пена)','./autoshampoo_a04O8mp.jpg',0,2,0,NULL),(5,'теплоноситель, антифриз, тосол','./antifreeze_8bDaKrm.jpg',0,6,0,NULL),(6,'перевозка грузов','./04.jpg',1,5,1,NULL),(7,'собственная спецтехника','./zakaz-manipulator.jpg',1,8,0,NULL),(8,'изделия из полипропилена','./polipropilen.jpg',0,7,1,NULL);
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$24000$Kaky1HQagglt$1VEuegLXfAtC6kMIkpvuQxpwutdgIw1NRED9qlNbY/I=','2016-08-21 09:37:38',1,'ancel','','','anceladamusic@gmail.com',1,1,'2016-07-30 15:15:25'),(2,'pbkdf2_sha256$24000$EFU6HDOUMwda$TCLiR45vUAgvLZ3otHiE7Ccb7t9YxCfVZRF7UZcwyz8=','2016-08-13 13:08:42',0,'leonid','','','',0,1,'2016-08-13 13:08:09');
...
-- Dump completed on 2016-08-21 15:32:20
